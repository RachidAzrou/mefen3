...
const steps: Step[] = [
  ...
  {
    title: "Dashboard",
    description: "Dit is je startpunt. Hier vind je een overzicht van de planning en bijkomende informatie.",
    element: "[href='/']"
  },
  {
    title: "Planning",
    description: "Bekijk en beheer hier alle planningen voor de vrijwilligers.",
    element: "[href='/planning']"
  },
  {
    title: "Vrijwilligers",
    description: "Hier vind je een overzicht van alle vrijwilligers en hun informatie.",
  ...
  {
    title: "Import/Export",
    description: "Hier beheer je alle nieuwe aanmeldingen en kun je een lijst exporteren.",
    element: "[href='/import-export']"
  },
  {
    title: "Mijn Moskee",
    description: "Hier vind je alle nodige informatie over de moskee",
    element: "[href='/Mijn Moskee']"
  }
];
